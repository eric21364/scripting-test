      ...
      <VStack spacing={8} padding={{ top: 12, leading: 2, trailing: 2, bottom: 8 }} frame={{ maxWidth: "infinity" }}>
        {mode === 0 ? (
          ...
          <VStack spacing={12} padding={10}>
            <HStack spacing={15}>
               <KeyView title="🦞 隱入塵煙" action={handleEncode} wide={true} minWidth={180} background="rgba(255, 69, 0, 0.25)" foregroundStyle="systemOrange" height={60} />
            ...
            <HStack spacing={15}>
               ...
               <KeyView title="返回主單" action={() => CustomKeyboard.dismissToHome()} wide={true} minWidth={180} background="rgba(255, 255, 255, 0.4)" />
            </HStack>
          </VStack>
        )}
      </VStack>
